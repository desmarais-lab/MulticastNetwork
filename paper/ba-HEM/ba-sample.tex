...
\begin{document}
	...
	\begin{algorithm}[!t]
		...
		\begin{algorithmic}
			...
			\IF{$a_d=$  NA}
			%\STATE compute the vector $\boldsymbol{\pi}_d$, from equation (\ref{eqn:latenttime}) (without the product term)
