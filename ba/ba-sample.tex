...
\begin{frontmatter}
\title{A Hyper-edge Event Model\thanksref{T1}}
\runtitle{A Hyper-edge Event Model}
\thankstext{T1}{Footnote to the title with the ``thankstext'' command.}

\begin{aug}
\author{\fnms{Bomin} \snm{Kim}\thanksref{addr1,t1,t2,m1}\ead[label=e1]{first@somewhere.com}},
\author{\fnms{Aaron} \snm{Achein}\thanksref{addr1,t3,m1,m2}\ead[label=e2]{second@somewhere.com}},
\author{\fnms{Bruce} \snm{Desmarais}\thanksref{addr1,t3,m1,m2}\ead[label=e2]{second@somewhere.com}},
\and
\author{\fnms{Hanna} \snm{Wallach}\thanksref{addr2,t1,m2}
...
the model to analyze emails sent between department managers in Montgomery county government in North Carolina. Our application demonstrates that the model is effective at predicting and explaining time-stamped network data involving edges with multiple recipients.
\end{abstract}
